...
DROP INDEX IF EXISTS "trade_accounts_evaluation_id_idx";--> statement-breakpoint
...
CREATE UNIQUE INDEX "trade_accounts_evaluation_id_idx" ON "trade_accounts" USING btree ("evaluation_id") WHERE "evaluation_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "trade_accounts_aso_account_id_idx" ON "trade_accounts" USING btree ("aso_account_id") WHERE "aso_account_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "trade_accounts_aso_source_account_id_idx" ON "trade_accounts" USING btree ("aso_source_account_id") WHERE "aso_source_account_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "trade_accounts_aso_number_idx" ON "trade_accounts" USING btree ("number") WHERE "typeofaccount" = 'Aso';--> statement-breakpoint
CREATE UNIQUE INDEX "aso_requests_open_ss_account_idx" ON "aso_requests" USING btree ("ss_account_id") WHERE "status" IN ('pending', 'approved');--> statement-breakpoint
CREATE UNIQUE INDEX "aso_requests_completed_ss_account_idx" ON "aso_requests" USING btree ("ss_account_id") WHERE "status" = 'completed';--> statement-breakpoint
...
CREATE INDEX "aso_requests_token_hash_idx" ON "aso_requests" USING btree ("approval_token_hash");
